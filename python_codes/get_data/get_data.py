...
# -------------------------------------------------------------------------------- NOTEBOOK-CELL: CODE
ATOKEN = open(“../credentials/atoken.txt”,”r”) 
ASECRET = open(“../credentials/asecret.txt”,”r”) 
CKEY = open(“../credentials/ckey.txt”,”r”) 
CSECRET = open(“../credentials/csecret.txt”,”r”) 
...
pd.save_csv(../data/raw_tweets.csv)